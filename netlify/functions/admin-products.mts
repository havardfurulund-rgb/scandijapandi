    ...
    if (req.method === "POST") {
      ...
      const [row] = await db.sql`
        INSERT INTO products (
          ...
          origin_story_en, origin_story_jp, producer_story_en, producer_story_jp,
          material_en, material_jp, care_instructions_en, care_instructions_jp,
        ...
        VALUES (
          ...
          ${body.origin_story_en || null}, ${body.origin_story_jp || null}, ${body.producer_story_en || null}, ${body.producer_story_jp || null},
          ${body.material_en || null}, ${body.material_jp || null}, ${body.care_instructions_en || null}, ${body.care_instructions_jp || null},
    ...
    if (req.method === "PUT") {
      ...
      const [row] = await db.sql`
        UPDATE products SET
          ...
          origin_story_en = ${body.origin_story_en ?? null},
          origin_story_jp = ${body.origin_story_jp ?? null},
          producer_story_en = ${body.producer_story_en ?? null},
          producer_story_jp = ${body.producer_story_jp ?? null},
          material_en = ${body.material_en ?? null},
          material_jp = ${body.material_jp ?? null},
          care_instructions_en = ${body.care_instructions_en ?? null},
          care_instructions_jp = ${body.care_instructions_jp ?? null},
